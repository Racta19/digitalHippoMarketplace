    ...
    if(isError){
        return(
            <div className=" flex flex-col items-center gap-2">
                ...
                <p className=" text-muted-foreground text-sm">The token is invalid or may have expired. Please try again.</p>
            </div>
        )
    }
    ...
    if(data?.success){
        return(
            <div className=" flex h-full flex-col items-center justify-center">
                ...
                <p className=" text-muted-foreground text-center mt-1">Email verified. Thank You</p>
