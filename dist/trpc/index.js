...
var auth_rotuer_1 = require("./auth-rotuer");
...
exports.appRouter = (0, trpc_1.router)({
    auth: auth_rotuer_1.authRouter,
    payment: payment_router_1.paymentRouter,
    getInfiniteProducts: trpc_1.publicProcedure.input(zod_1.z.object({ limit: zod_1.z.number().min(1).max(100), cursor: zod_1.z.number().nullish(), query: query_validator_1.QueryValidator })).query(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
